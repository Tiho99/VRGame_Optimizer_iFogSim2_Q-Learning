...
//            // Limite la durée de simulation à 1000ms
...
//            ModulePlacementLatencyAware mp = new ModulePlacementLatencyAware(fogDevices, application, moduleMapping);
//            controller.submitApplication(application, 0,
//                    CLOUD ? new ModulePlacementMapping(fogDevices, application, moduleMapping) : mp);
//
//            TimeKeeper.getInstance().setSimulationStartTime(Calendar.getInstance().getTimeInMillis());
//
//            System.out.println("RANI HNA 222");
//            CloudSim.startSimulation();      // Un seul appel
//            
//            new Thread(() -> {
//                try {
//                    Thread.sleep(10000); // 10 secondes réelles max
...
//            }).start();
//            
//            System.out.println("RANI HNA 333 - Simulation terminée");
//            CloudSim.stopSimulation();
//            System.out.println("RANI HNA 444 - Simulation terminée");
//            
//            
//         // ── Q-TABLE UPDATE from simulation results ──────────
...
//                    double measuredLatency = entry.getValue();
//                    if (measuredLatency > 0) {
//                        // Find where concentration_calculator was placed
//                        List<Integer> devices = mp.getModuleToDeviceMap()
//                                                  .get("concentration_calculator");
//                        if (devices != null) {
//                            for (int deviceId : devices) {
//                                mp.updateQTable("concentration_calculator",
//                                                deviceId,
//                                                measuredLatency);
//                            }
//                        }
